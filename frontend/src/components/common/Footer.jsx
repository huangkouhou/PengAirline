        ...
        <footer className="footer">
            ...
            <div className="footer-container">
                <div className="footer-section">
                    <h3 className="footer-heading">Peng Airline</h3>
                ...
                <div className="footer-section">
                    ...
                    <ul className="footer-links">
                        <li><Link className="footer-link" to="/terms">Terms of the Service</Link></li>
            ...
            <div className="footer-bottom">
                <p>&copy; {new Date().getFullYear()} Peng Airline. All Rights Reserved.</p>
            </div>
